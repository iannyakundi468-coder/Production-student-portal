  ...
  return (
    ...
    >
      ...
      <div className="quick-actions">
        <button className="btn-primary" onClick={() => navigate('/parent/pay')}>
          <CreditCard size={24} />
          {t.payFees}
        </button>
        <button className="btn-secondary" onClick={() => navigate('/parent/progress')}>
          <PieChart size={24} />
          {t.progress}
        </button>
        <button className="btn-secondary" onClick={() => navigate('/parent/messages')}>
