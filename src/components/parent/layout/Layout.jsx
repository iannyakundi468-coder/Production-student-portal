...
export default function Layout() {
  ...
  const navItems = [
    { path: '/parent', icon: Home, label: t.dashboard },
    { path: '/parent/pay', icon: CreditCard, label: t.payFees },
    { path: '/parent/progress', icon: PieChart, label: t.progress },
    { path: '/parent/messages', icon: MessageSquare, label: t.messages }
  ];
    ...
    <div className={`parent-portal-theme ${theme === 'dark' ? 'dark-theme' : ''}`}>
      ...
      <aside className="desktop-sidebar">
        ...
        <div className="sidebar-footer">
          ...
          <div style={{ display: 'flex', background: 'var(--bg-color)', padding: '0.25rem', borderRadius: 'var(--radius-sm)', border: '1px solid var(--border-color)', justifyContent: 'space-around' }}>
            <button 
              style={{ color: theme === 'light' ? 'var(--primary)' : 'var(--text-muted)', padding: '0.4rem', borderRadius: '4px', background: theme === 'light' ? 'var(--surface)' : 'transparent', flex: 1, display: 'flex', justifyContent: 'center', border: 'none', cursor: 'pointer' }} 
            ...
            <button 
              style={{ color: theme === 'dark' ? 'var(--primary)' : 'var(--text-muted)', padding: '0.4rem', borderRadius: '4px', background: theme === 'dark' ? 'var(--surface)' : 'transparent', flex: 1, display: 'flex', justifyContent: 'center', border: 'none', cursor: 'pointer' }} 
            ...
            <button 
              style={{ color: theme === 'system' ? 'var(--primary)' : 'var(--text-muted)', padding: '0.4rem', borderRadius: '4px', background: theme === 'system' ? 'var(--surface)' : 'transparent', flex: 1, display: 'flex', justifyContent: 'center', border: 'none', cursor: 'pointer' }} 
          ...
          <div style={{ display: 'flex', gap: '0.5rem' }}>
            <button className="lang-switch" onClick={toggleLanguage} style={{ flex: 1, textAlign: 'center', border: 'none', cursor: 'pointer' }}>
      ...
      <header className="top-nav">
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          <button className="lang-switch" onClick={toggleLanguage} style={{ padding: '0.4rem 0.6rem', fontSize: '0.75rem', border: 'none', cursor: 'pointer' }}>
            {language === 'en' ? 'SW' : 'EN'}
          </button>
            ...
            {showProfileMenu && (
              ...
              >
                ...
                <div style={{ display: 'flex', gap: '0.25rem', marginBottom: '0.5rem', background: 'var(--bg-color)', padding: '0.2rem', borderRadius: '8px' }}>
                  <button style={{ flex: 1, padding: '0.25rem', fontSize: '0.75rem', color: theme === 'light' ? 'var(--primary)' : 'var(--text-muted)', background: theme === 'light' ? 'var(--surface)' : 'transparent', borderRadius: '4px', display: 'flex', justifyContent: 'center', border: 'none', cursor: 'pointer' }} onClick={() => updateTheme('light')}><Sun size={12} /></button>
                  <button style={{ flex: 1, padding: '0.25rem', fontSize: '0.75rem', color: theme === 'dark' ? 'var(--primary)' : 'var(--text-muted)', background: theme === 'dark' ? 'var(--surface)' : 'transparent', borderRadius: '4px', display: 'flex', justifyContent: 'center', border: 'none', cursor: 'pointer' }} onClick={() => updateTheme('dark')}><Moon size={12} /></button>
                  <button style={{ flex: 1, padding: '0.25rem', fontSize: '0.75rem', color: theme === 'system' ? 'var(--primary)' : 'var(--text-muted)', background: theme === 'system' ? 'var(--surface)' : 'transparent', borderRadius: '4px', display: 'flex', justifyContent: 'center', border: 'none', cursor: 'pointer' }} onClick={() => updateTheme('system')}><Monitor size={12} /></button>
                </div>
          ...
          >
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
                ...
                <button onClick={() => setShowEditProfileModal(false)} style={{ padding: '0.25rem', color: 'var(--text-muted)', border: 'none', background: 'none', cursor: 'pointer' }}>
                  <X size={20} />
                </button>
              </div>
