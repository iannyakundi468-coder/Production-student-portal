...
export default function ThemeCustomizer() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 print:hidden text-slate-800">
      ...
      {isOpen && (
        <div className="absolute bottom-16 right-0 bg-white/90 backdrop-blur-md border border-slate-200 p-4 rounded-lg shadow-xl w-60 animate-in slide-in-from-bottom-5 duration-300">
            ...
            {themes.map((t) => (
              ...
              >
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="text-xs text-slate-750">{t.name}</span>
                </div>
