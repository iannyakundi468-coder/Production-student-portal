...
export default function Layout() {
  ...
  return (
    <div className="flex h-screen bg-slate-50/20 text-slate-900 font-sans overflow-hidden">
        ...
        <div className="h-full flex flex-col justify-between">
          ...
          <div className="p-4 border-t border-slate-100 bg-white">
            <div className="flex items-center gap-3 p-2 rounded hover:bg-slate-50 transition-colors cursor-pointer group">
              <div className="w-8 h-8 rounded bg-slate-50 flex items-center justify-center text-xs font-bold text-slate-650 overflow-hidden border border-slate-200">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-xs font-bold text-slate-900 truncate">{teacherData?.name || 'Teacher'}</p>
                <p className="text-[10px] text-slate-400 truncate">{teacherData?.school || "St. Joseph's Academy"}</p>
              </div>
              <button onClick={handleLogout} className="text-slate-450 hover:text-red-500 transition-colors">
                <LogOut size={16} />
              </button>
            </div>
          </div>
      ...
      {/* Main Container */}
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden bg-slate-55/30">
        ...
        <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-6 z-30">
          ...
          <div className="hidden md:flex items-center gap-2 text-sm text-slate-500 font-medium">
            ...
            <span className="text-slate-900">Teacher Dashboard</span>
          </div>
